...
** application health
** consumer groups and their lags
...
In this article we have explained the strategies and plans involved in migration of an AMQ Streams cluster in an _Active/Passive_ setting between two RHOCP installations.
