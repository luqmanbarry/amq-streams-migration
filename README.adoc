...
* https://kubernetes.io/docs/concepts/policy/pid-limiting/[Kubernetes docs on PIDs limit]
* https://computingforgeeks.com/change-pids-limit-value-in-openshift/[Change PIDs limit in Openshift]
