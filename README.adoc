...
In simple terms, there was a need to migrate a pre-existing AMQ Streams(v1.4) cluster from Openshift 3.11 to AMQ Streams(v1.7) on Openshift 4.7.
...
This plan might be per use case basis, but the simplest form is as follow:
...
include::technical-implementation.adoc[technical implemention]
